 ...
 * @version v.1.0
 * 
 *          작업이력 ] 2024.06.03 - 담당자 : 허광혁 리스트 폼보기 요청 글쓰기 폼보기 요청
 */
@Controller
@RequestMapping("/reboard")
public class Reboard {
	@RequestMapping("/reboard.cafe")
	public ModelAndView getReboard(HttpSession session, ModelAndView mv, RedirectView rv, PageUtil page) {
	...
	public ModelAndView reboardWrite(HttpSession session, ModelAndView mv, RedirectView rv, String nowPage,
			ReboardVO rVO) {
